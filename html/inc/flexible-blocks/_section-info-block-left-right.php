<!-- SLIDER INFO BLOCK -->
<div class="section info-block left-right">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 ps-md-0">
                <div class="info-block-img type-2 ms-lg-auto">
                    <div class="decor-bg rellax" data-rellax-speed="1"
                        style="background-image: url('./img/background-shape-1.svg');"></div>
                    <div class="decor-ring rellax" data-rellax-speed="1"
                        style="background-image: url('./img/ring-1.svg');"></div>
                    <picture>
