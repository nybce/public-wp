              ...
              <div class="row justify-content-center footer-top-inner">
                  ...
                  <div class="col-xl-8">
                      <div class="title-wrapper type-2">
                          ...
                          <div class="text text-30 text-center">New York Blood Center (NYBC) is one of the largest
                              community-based,
                              non-profit blood collection and distribution organizations in the United States.</div>
                      </div>
                  </div>
                  ...
                  <div class="col-xl-10">
                      <div class="logo-wrapper">
                          <div class="logo-img">
                              <img src="img/content/logo-1.svg" alt="" loading="lazy">
                          </div>
                          <div class="logo-img">
                              <img src="img/content/logo-2.svg" alt="" loading="lazy">
                          </div>
                          <div class="logo-img">
                              <img src="img/content/logo-3.svg" alt="" loading="lazy">
                          </div>
                          <div class="logo-img">
                              <img src="img/content/logo-4.svg" alt="" loading="lazy">
                          </div>
                          <div class="logo-img">
                              <img src="img/content/logo-5.svg" alt="" loading="lazy">
                          </div>
                          <div class="logo-img">
                              <img src="img/content/logo-6.svg" alt="" loading="lazy">
                          </div>
                      </div>
                  </div>
                              ...
                              <li>
                                  <a href="https://www.youtube.com/" target="_blank">
                                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                          xmlns="http://www.w3.org/2000/svg">
                                          <path
                                              d="M22.0575 6.94502C21.9379 6.50105 21.7039 6.09626 21.3788 5.77115C21.0537 5.44604 20.6489 5.21203 20.205 5.09252C18.57 4.65002 12 4.65002 12 4.65002C12 4.65002 5.42995 4.65002 3.79495 5.09252C3.35098 5.21203 2.94619 5.44604 2.62108 5.77115C2.29597 6.09626 2.06196 6.50105 1.94245 6.94502C1.63716 8.61247 1.48901 10.3049 1.49995 12C1.48901 13.6952 1.63716 15.3876 1.94245 17.055C2.06196 17.499 2.29597 17.9038 2.62108 18.2289C2.94619 18.554 3.35098 18.788 3.79495 18.9075C5.42995 19.35 12 19.35 12 19.35C12 19.35 18.57 19.35 20.205 18.9075C20.6489 18.788 21.0537 18.554 21.3788 18.2289C21.7039 17.9038 21.9379 17.499 22.0575 17.055C22.3627 15.3876 22.5109 13.6952 22.5 12C22.5109 10.3049 22.3627 8.61247 22.0575 6.94502ZM9.89995 15.15V8.85002L15.3525 12L9.89995 15.15Z"
                                              fill="white" />
                                      </svg>
                                  </a>
                              </li>
      ...
      <div class="footer-bottom">
          ...
          <div class="container">
              <div class="row">
                  <div class="col-lg-4">
                      <div class="copyright">
                          <div class="text-sm text-40">©2022 New York Blood Center</div>
                      </div>
                  ...
                  <div class="col-lg-4">
                      <div class="developer">
                          <a href="#">
                              ...
                              <img src="img/blenderbox-logo.svg" alt="" loading="lazy">
                          </a>
                      </div>
                  </div>
              </div>
