...
<div class="section banner <?= $className?>" id="<?= $id?>">
    ...
    <div class="banner-inner">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="banner-content">
                            ...
                            <? if(!empty($button)) { ?>
                                <a class="btn btn-primary" target="<?= $button['target'] ?>" href="<?= $button['url'] ?>"><?= $button['title'] ?></a>
                            <? } ?>
                        </div>
                    </div>
                </div>
        ...
        <?php if(!empty($media)) { ?>
            ...
            <div class="bg rellax" style="background-image: url('<?= $media['url']?>');"></div>

        <? } elseif(!empty($video)) {?>

            <div class="bg video rellax">
               <video src="<?= $video?>" class="video" autoplay="" loop="" preload="" muted="" playsinline=""></video>
            </div>
