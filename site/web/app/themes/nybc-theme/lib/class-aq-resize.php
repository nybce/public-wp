...
if ( ! class_exists( 'Aq_Resize' ) ) {
	...
	class Aq_Resize {
		 ...
		 * @param bool   $crop   doing crop.
		 * @param bool   $single  return single.
		 * @param bool   $upscale  doingb upsacale.
		 *
		 * @throws Exception Std exception.
		 *
		 * @return  array|string
		 */
		 ...
		 *
		 * @param bool $default  url.
		 * @param int  $orig_w  width.
		 * @param int  $orig_h  height.
		 * @param int  $dest_w   doing crop.
		 * @param int  $dest_h  return single.
		 * @param bool $crop  doingb upsacale.
		 *
		 * @return  array
		 */
...
if ( ! function_exists( 'aq_resize' ) ) {
	...
	function aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
		...
		$aq_resize = Aq_Resize::get_instance();
