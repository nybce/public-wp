...
use PublishPress\Addon\Reminders\Workflow\Step\Event\AfterPublishing;

class AfterTimer extends BaseTimer
{
    const META_KEY_POST_STATUS_AMOUNT = '_psppno_pubafteramount';

    const META_KEY_POST_STATUS_UNIT = '_psppno_pubafterunit';
    ...
    {
        return (bool)get_post_meta($workflowId, AfterPublishing::META_KEY_SELECTED, true);
    }
}
