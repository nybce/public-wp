...
class RevisionaryProSettingsUI {
    ...
    function fltOptionCaptions($captions) {
        $captions['pending_revision_unpublished'] = (rvy_get_option('revision_statuses_noun_labels')) ? __('Change Requests for Unpublished Posts', 'revisionary') :  __('Revision Submission for Unpublished Posts', 'revisionary');
