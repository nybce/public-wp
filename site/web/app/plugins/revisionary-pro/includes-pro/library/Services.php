...
if (!class_exists('\Alledia\EDD_SL_Plugin_Updater')) {
    require_once(RVY_ABSPATH . '/vendor/alledia/edd-sl-plugin-updater/EDD_SL_Plugin_Updater.php');
}
*/
...
foreach([
    ...
    if (!class_exists('\PublishPress\EDD_License\Core\\' . $class)) {
        //require_once(RVY_ABSPATH . "/vendor/alledia/wordpress-edd-license-integration/src/core/$class.php");
